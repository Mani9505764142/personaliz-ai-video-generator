...
// Send POST request for video
app.post('/api/whatsapp/send-video', (req, res) => {
  ...
  res.json({
    success: true,
    message: `📱 Video sent to ${name} via POST method!`,
    data: messageData
  });
});
...
app.listen(PORT, () => {
  ...
  console.log(`   📤 POST http://localhost:${PORT}/api/whatsapp/send-video`);
  console.log('===============================================\n');
});
